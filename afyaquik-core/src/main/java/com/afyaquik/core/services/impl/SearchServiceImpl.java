...
public class SearchServiceImpl implements SearchService {
    ...
    private Class<?> resolveEntityClass(String key) throws ClassNotFoundException {
        return switch (key) {
            ...
            case "settings" -> Class.forName("com.afyaquik.core.settings.entity.GeneralSettings");
    ...
    private Class<?> resolveDtoClass(String key) throws ClassNotFoundException {
        return switch (key) {
            case "users" -> Class.forName("com.afyaquik.dtos.user.UserDto");
            case "roles" -> Class.forName("com.afyaquik.dtos.user.RoleResponse");
            case "stations" -> Class.forName("com.afyaquik.dtos.user.StationDto");
            case "patients" -> Class.forName("com.afyaquik.dtos.patient.PatientDto");
            case "appointments" -> Class.forName("com.afyaquik.dtos.appointments.AppointmentDto");
            case "visits" -> Class.forName("com.afyaquik.dtos.patient.PatientVisitDto");
