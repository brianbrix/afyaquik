...
const modules: AfyaQuikModule[] = [
    ...
    { name: 'Pharmacy Dashboard', path: '/client/pharmacy/index.html', description: 'Handle pharmacy records', icon: 'bi-clipboard2-pulse-fill', requiredRoles: ['NURSE','PHARMACIST'] },
